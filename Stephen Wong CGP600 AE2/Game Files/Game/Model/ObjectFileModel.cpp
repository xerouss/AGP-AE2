...
// draw object
void ObjectFileModel::Draw(void)
{
...
ObjectFileModel::ObjectFileModel(char* fname, ID3D11Device* device, ID3D11DeviceContext* context)
{
	pD3DDevice = device;
...
int ObjectFileModel::loadfile(char* fname)
{
	FILE* pFile;
...
void ObjectFileModel::parsefile()
{
...
bool ObjectFileModel::getnexttoken(int& tokenstart, int& tokenlength)
{
	tokenstart = tokenptr;
	tokenlength = 1;
	int tokenend;
...
bool ObjectFileModel::getnextline()
{
...
ObjectFileModel::~ObjectFileModel()
{
